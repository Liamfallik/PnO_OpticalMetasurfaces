...
scriptName = "Retroreflector_Test6_1_S5_S15_Half_Symm_C" # 20 deg and 10 deg
...
for sample_nr in range(num_samples):
    ...
    for freq in frequencies:
        ...
        fileName = f"./" + scriptName + "/" + scriptName_i + "/Angle20_fieldAtWavelength" + str(1/freq) + ".png"
        ...
        fileName = f"./" + scriptName + "/" + scriptName_i + "/Angle10_fieldAtWavelength" + str(1 / freq) + ".png"
        plt.savefig(fileName)
