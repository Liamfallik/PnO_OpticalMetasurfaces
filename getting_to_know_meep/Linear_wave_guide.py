...
# Frequency in Meep units. f = c [µm/s] * 0.15 [1/µm] = 4.5e13 Hz
# Wavelength is just 1/0.15[1/µm] = 6.67 µm ~ about 2 µm in high-index material
sources = [mp.Source(mp.ContinuousSource(frequency=0.15),
                     component=mp.Ez, # transversal polarization
                     center=mp.Vector3(-7,0))] # Located on the left side (1 cm from edge)
