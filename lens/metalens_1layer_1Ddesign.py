...
scriptName = "metalens_1layer_1Ddesign3_img"
...
design_variables = mp.MaterialGrid(mp.Vector3(Nx), Air, Si, grid_type="U_MEAN")
...
NearRegions = [ # region from which fields at focus point will be calculated
    mp.Near2FarRegion(
        center=mp.Vector3(0, design_region_height / 2 + 0.4), # 0.4 µm above lens
...
np.random.seed(seed)
x = np.random.rand(n) * 0.6 # average everywhere
# file_path = "x.npy"
