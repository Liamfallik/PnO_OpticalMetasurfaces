...
def sendNotification(message):
	...
	try:
		response = requests.post(url, json={'chat_id': myuserid, 'text': message})
		print(response.text)
...
design_region_height = [0.52, 0.376] # height of layer
...
resolution = 55 # 50 --> amount of grid points per µm; needs to be > 49 for TiOx and 0.55 µm
...
focal_point = 7.5
far_x = [mp.Vector3(-3, focal_point, 0), mp.Vector3(3, focal_point, 0)]
